...
- report image captions can be branded with `layout.report_image_caption`: optional `align`, semantic/palette `color`, `size`, `line_height`, `gap`, `padding_x`, and `bottom_gap`; omitted values use the shared render configuration;
